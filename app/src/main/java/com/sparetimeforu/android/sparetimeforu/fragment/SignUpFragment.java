...
public class SignUpFragment extends Fragment implements View.OnClickListener{
    ...
    static String url="http://172.16.92.161:5000";
    ...
    * */
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.btn_signup){
            ...
            String email=username+username_back;//完整的邮箱
            ...
            OkHttpUtil.sendLoginOkHttpPostRequest(url, body,
                    new Callback() {
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                                String respone_body=response.toString();
                                try {
                                    JSONObject jsonObject=new JSONObject(respone_body);
