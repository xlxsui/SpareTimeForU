...
public class Errand_received_fragment extends Fragment{
    ...
    private void loadMissionDoing(){
        ...
        if(mErrandFragment==null){
            ...
            Toast.makeText(getActivity(),"进行中任务1"+bundle.getInt("mode"),Toast.LENGTH_SHORT).show();
        }else {
            ...
            if(bundle.getInt("mode")!=RECEIVED_MISSION_DOING){
                ...
                Toast.makeText(getActivity(),"进行中任务2"+bundle.getInt("mode"),Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void loadMissionDone(){
        ...
        if(mErrandFragment==null){
            ...
            mErrandFragment.setArguments(bundle);
            Toast.makeText(getActivity(),"完成的任务1"+bundle.getInt("mode"),Toast.LENGTH_SHORT).show();
            ...
            if(bundle.getInt("mode")!=RECEIVED_MISSION_DONE){
                ...
                mErrandFragment.setArguments(bundle1);
                Toast.makeText(getActivity(),"完成的任务2"+bundle.getInt("mode"),Toast.LENGTH_SHORT).show();
